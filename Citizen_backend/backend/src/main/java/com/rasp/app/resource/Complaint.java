...
@Component
 public class Complaint extends BaseResource {
	...
	private Long complaint_id = null;
	...
	private Long curr_dept_id = null;
	...
	public static String FIELD_COMPLAINT_ID = "complaint_id";
	...
	static {
		...
		Field complaint_idField = new Field("complaint_id", "Long");
		complaint_idField.setRequired(true);
		metaData.addField(complaint_idField);

		Field citizen_idField = new Field("citizen_id", "Long");
		citizen_idField.setRequired(true);
		citizen_idField.setForeign(new Foreign("Citizen"));
		...
		Field curr_dept_idField = new Field("curr_dept_id", "Long");
		curr_dept_idField.setForeign(new Foreign("Department"));
	...
	public Complaint(Complaint obj) {
		...
		this.complaint_id = obj.complaint_id;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		complaint_id = (map.get("complaint_id") == null ? null : ((Number) map.get("complaint_id")).longValue());
		...
		curr_dept_id = (map.get("curr_dept_id") == null ? null : ((Number) map.get("curr_dept_id")).longValue());
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object complaint_idObj = map.get("complaint_id");
		if(complaint_idObj != null)
			complaint_id = new Long(complaint_idObj.toString());
		...
		if(curr_dept_idObj != null)
			curr_dept_id = new Long(curr_dept_idObj.toString());
	...
	public void unSetComplaint_id() {
		this.complaint_id = null;
	}

	public boolean validateComplaint_id(boolean add) throws ApplicationException {
		if(add && complaint_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[complaint_id]");
		return complaint_id != null;
	}
	...
	public Long getCurr_dept_id() {
		return curr_dept_id;
	}

	public void setCurr_dept_id(Long curr_dept_id) {
